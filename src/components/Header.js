    ...
    return (
      ...
      <div className="navbar-absolute header-top">
        ...
        <ul className="left-side navbar-nav">
           ...
           <Link to="/"><img src="img/pdt-logo.png" className="logo2" alt="logo"/></Link>
           </li>
           </ul>
          <ul className="navbar-nav right-side">
            <li className="nav-item"><Link to="/"><i className="fa fa-clock-o"/></Link></li>
            <li className="nav-item"><Link to="/"><i className="fa fa-star"/></Link></li> 
            <li className="nav-item"><Link to="/"><i className="fa fa-home"/></Link></li> 
            <div className="dropdown d-none d-lg-block">
              <button className="btn btn-transparent dropdown-toggle" type="button" data-toggle="collapse" data-target="#dropdownMenuButton" aria-controls="dropdownMenuButton">
                <i className="fa fa-user"/> &nbsp;&nbsp; Murray McC</button>
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item">
              <Link to="/map">
                Support &nbsp;&nbsp;<i className="fa fa-phone"/>
                </Link>
              </li>
              <li className="nav-item"><Link to="/map">feedback &nbsp;&nbsp; <i className="fa fa-comment"/></Link></li>
            </ul>
